...
```text
Gestionale.Intenzioni.Messe_0.1.12_x64-setup.exe
```

In alternativa:

1. Copia su chiavetta uno dei file generati nella cartella `src-tauri/target/release/bundle/`:
   - `nsis/Gestionale Intenzioni Messe_0.1.12_x64-setup.exe`, consigliato per l'installazione guidata;
   - `msi/Gestionale Intenzioni Messe_0.1.12_x64_en-US.msi`, utile in ambienti Windows gestiti.
...
3. Copia su chiavetta il file `Gestionale Intenzioni Messe_0.1.12_x64-setup.exe`.
